...
const Header = ({ goBack, isCompleted }) => {
  return (
    <header className="flex items-center px-3 w-full border-b-[1px] border-b-[#ECEEEB] py-5 md:px-20 md:justify-start">
      <div className="flex flex-row justify-between  items-center w-full md:gap-5 md:w-fit">
        ...
        <div className="flex items-center justify-center py-[1px] px-[6px] rounded h-[18px] bg-[#5552D914]">
          <p
            className={`${
              isCompleted ? "text-[#4ADE80]" : "text-[#6F6FFF]"
            } text-center text-[12px] leading-6 `}
          >
